 ...
 */
public class parkMap extends ride{
    
    //a data map type data structure class, will be used by mapUI to be displayed
    ...
    public void removeRideFromMap(){    
    }
    
    public void changeRideLocation(){
    }
}
